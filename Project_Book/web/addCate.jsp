<%-- 
    Document   : addCate
    Created on : Nov 4, 2022, 5:35:47 PM
    Author     : TrongHoa
--%>
...
<html>
    ...
    <body>
        ...
        <div class="admin">
            ...
            <form class="detail" action="addCate" method="post">
                <div class="detail-text">
                    <span>Thể loại sách: </span><input placeholder="Nhập tên thể loại sách" required class="input" type="text" name="cate"/><br/>
